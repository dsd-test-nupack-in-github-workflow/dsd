...
void render(Document &doc, Type<DomainList> t) {
    ...
    rebind::VectorRenderer<DomainList>()(doc, false);
    render_comparisons(doc, t);
    render_json(doc, t);
    doc.method(t, "new", rebind::construct<DomainList>(t));
    doc.method(t, "__hash__", [](DomainList const &v) {return range_hash(v);});

    doc.method(t, "__contains__", [] (DomainList const &v, Domain const &d) {return contains(v, d);});

    doc.method(t, "reverse_complement", [](DomainList const &v, bool b) -> DomainList {
        return vmap<DomainList>(reversed(v), [b](auto const &d) {return d.reverse_complement(b);});
    });

    doc.method(t, "+", [](DomainList a, Domain b) {a.emplace_back(std::move(b)); return a;});
    doc.method(t, "+", [](DomainList a, DomainList b) {
        a.insert(a.end(), std::make_move_iterator(b.begin()), std::make_move_iterator(b.end()));
        return a;
    });
    doc.method(t, "nt", [](DomainList const &v) {return sum(v, len);});
}

/******************************************************************************************/

template <class T>
bool compare_complexes(Complex const &a, Complex const &b) {
    return T()(lowest_rotation(a), lowest_rotation(b));
}
...
void render(Document &doc, Type<Domain> t) {
    ...
    doc.method(t, "+", [](Domain a, Domain b) {return DomainList{std::move(a), std::move(b)};});
    doc.method(t, "+", [](Domain a, DomainList b) {b.insert(b.begin(), std::move(a)); return b;});
